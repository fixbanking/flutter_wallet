...
class FlutterWallet {
    ...
    await _channel.invokeMethod('addCardToGooglePay', {
      ...
      "address": response.address == null
          ...
          : {
              ...
              "administrativeArea": response.address.administrativeArea
            }
    });
  }
  ...
  static Future<dynamic> initiateiOSAddPaymentPassFlow(
      ...
      @required
          FutureOr<PKAddPaymentPassRequest> Function(List<String> certificates,
                  String nonce, String nonceSignature)
              onData}) async {
    ...
    try {
      final response =
        ...
        "paymentNetwork": paymentNetwork.toString().split('.')[1],
      });
  ...
  static Future<String> getGooglePayStableHardwareId() async =>
