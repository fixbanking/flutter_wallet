...
class _MyAppState extends State<MyApp> {
          ...
          body: Column(
            children: [
              if (Platform.isIOS) ...[
                ...
                LayoutBuilder(
                    builder: (context, constraints) => PKAddPassButton(
                        width: constraints.maxWidth, height: 100)),
              ] else ...[
                ElevatedButton(
                    onPressed: () => _startGooglePay(),
                    child: Text("Add to Google Pay"))
              ]
            ],
          ),
        ),
  ...
  _startGooglePay() {
    FlutterWallet.initiateGooglePayCardFlow(
        displayName: "John Smith",
        phoneNumber: "+1111111111",
        onData: (walletId, deviceId) => GooglePayRequest(
            "1234",
            "34234",
            GoogleUserAddress(
                city: "Atlanta",
